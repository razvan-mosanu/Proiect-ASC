...
imul_hi_indice_linie:
 ...
 .global main
 main:
 movl $0b11011111111110111111, variabile+0
 ...
 movzbl (%ecx,%ebx,1), %edx
 movb %dl, flag_zero
 movl $32, variabile+12
 et_loop:
 movl $1, %eax
 movzbl tabel_mask(%eax), %eax
 movzbl variabile+0, %ebx
 movzbl tabel_mask(%ebx), %ebx
 movl and_indice_linie(,%eax,4), %ecx
 movzbl (%ecx,%ebx,1), %edx
 movl zero_indice_linie(,%edx,4), %ecx
 ...
 movl $1, %ebx
 movzbl tabel_mask(%ebx), %ebx
 movl shr_indice_linie(,%eax,4), %ecx
 movzbl (%ecx,%ebx,1), %edx
